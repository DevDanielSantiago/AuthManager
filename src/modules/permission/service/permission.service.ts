...
import { ConflictException, NotFoundException } from 'src/common/exception';

import { ListResponseDto, MessageResponseDto } from 'src/common/dto';
import {
  PermissionDto,
...
import { PermissionRepository } from 'src/modules/permission/repository/permission.repository';
